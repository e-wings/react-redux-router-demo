...
gulp.task('scripts', function() {
  return gulp.src(webpackConfig.entry)
    ...
    .pipe(isProduction ? $.uglify({mangle:false}) : $.util.noop())
...
gulp.task('images', function(cb) {
  return gulp.src(app + 'images/**/*.{png,jpg,jpeg,gif,eot,svg,ttf,woff}')
...
gulp.task('default', ['images', 'html','scripts', 'json', 'styles', 'serve', 'watch']);
